    ...
    if auth_header ~= nil then
        if string.find(auth_header, "Basic") then
            ...
            if basichttpcred ~= nil then
               if string.find(ngx.var.request_uri, "/marathon/") or string.find(ngx.var.request_uri, "/mesos/") or string.find(ngx.var.request_uri, "/package/") or string.find(ngx.var.request_uri, "/exhibitor/") then
